...
function titleCase(title) {
  ...
  if (title !== '') {
    if (title.includes(':')) {
      ...
      var mainTitle = capitalizeWords(removeEmptyStrings(titleParts[0].split(' ')));
      var subTitle = capitalizeWords(removeEmptyStrings(titleParts[1].split(' ')));
...
function capitalizeWords(array) {
  ...
  for (var i = 0; i < array.length; i++) {
    if (splitPunctuation(array[i])[0].toUpperCase() === 'API') {
      newArray[i] = splitPunctuation(array[i])[0].toUpperCase() + splitPunctuation(array[i])[1];
    ...
    } else if (array[i].length <= 3 && i !== 0 && !isMajorWord(array[i].toLowerCase())) {
      newArray[i] = array[i].toLowerCase();
    } else {
      newArray[i] = capitalize(array[i]);
    }
...
function isPreposition(string) {
  return string === 'to' || string === 'at' || string === 'at' || string === 'on' || string === 'in' || string === 'for' || string === 'by' || string === 'with' || string === 'from' || string === 'of' || string === 'over' || string === 'under' || string === 'out' || string === 'about' || string === 'between' || string === 'through' || string === 'after' || string === 'before' || string === 'above' || string === 'below' || string === 'to' || string === 'from' || string === 'up' || string === 'down' || string === 'over' || string === 'under' || string === 'through' || string === 'above' || string === 'below';
}
...
function isMajorWord(string) {
  return string === 'web' || string === 'pop' || string === 'cat' || string === 'hat' || string === 'ham' || string === 'i' || string === 'pet';
}
