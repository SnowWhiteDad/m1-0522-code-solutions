...
console.log('');
var players = ['Iron Man', 'Super Man', 'Batman', 'Ip Man'];
var cardsPerHand = 2;
var playerNames = players;
var playerNamestoString = playerNames.toString();
console.log(players.length + ' players: ', playerNamestoString);
console.log('Cards per hand: ', cardsPerHand);
var result = main(players, cardsPerHand);
...
function main(players, cardsPerHand) {
  ...
  for (i = 0; i < gamePlayers.length; i++) {
    var score = 0;
    for (j = 0; j < gamePlayers[i].hand.length; j++) {
  ...
  if (highestScoringPlayers.length === 1) {
    ...
    var highestScoringPlayerNames = [];
    for (i = 0; i < highestScoringPlayers.length; i++) {
